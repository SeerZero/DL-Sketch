...
def mice_train_input():
    ...
    for epoch in range(train_ep - 1):
        server_file_name = "../data/sketch/sp" + str(sp_para) + "_ep" +str(epoch) + "_"  + sk_name[sk_type] + "_" + str(sk_r) + ".sketch"
    ...
    server_file_name = "../data/sketch/sp1" + "_ep0" + "_" + sk_name[sk_type] + "_" + str(sk_r) + ".sketch"
    
    (test_x, _, _, _, test_y) = data_input(server_file_name, 0)
    min = BATCH_SIZE_MICE
    if min >len(test_x):
        min = len(test_x)
...
def mice_test_input():
    ...
    for epoch in range(TestEpoch):
        server_file_name = "../data/sketch/sp1" + "_ep" +str(epoch) + "_"  + sk_name[sk_type] + "_" + str(sk_r) + ".sketch"
